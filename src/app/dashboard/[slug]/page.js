	...
	return (
		<div className="p-8 max-w-4xl mx-auto">
			...
			<div className="space-y-4">
				...
				{items?.map((item) => (
					<div key={item.id} className="border p-4 rounded bg-white shadow-sm flex gap-4 items-start">

						{/* --- BLOQUE DE IMAGEN --- */}
						{item.image_url && (
							<div className="w-24 h-24 shrink-0 rounded-md overflow-hidden bg-gray-100 border">
								<img
									src={item.image_url}
									alt={item.title}
						...
						<div className="flex-1"> {/* Agregamos flex-1 para que ocupe el resto */}
